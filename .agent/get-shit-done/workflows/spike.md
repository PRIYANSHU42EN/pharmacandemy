...
**c.** Assess observability needs before writing code. Ask: **can the agent fully verify this spike's outcome by running a command and reading stdout, or does it require human interaction with a runtime?**
...
- Anything the agent can run and check the output of directly
