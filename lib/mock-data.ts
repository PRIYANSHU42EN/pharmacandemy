...
export const MOCK_SUBJECTS: Subject[] = [
  // B.Pharm subjects
  { id: "sub-pharma-chem-1", courseId: "bpharm", semesterNumber: 1, name: "Pharmaceutical Chemistry I", description: "Inorganic pharmaceutical chemistry, acids, bases, and buffers.", resourceCount: 12, createdAt: now, updatedAt: now },
  { id: "sub-pharma-analysis", courseId: "bpharm", semesterNumber: 1, name: "Pharmaceutical Analysis I", description: "Qualitative and quantitative analysis methods used in pharmacy.", resourceCount: 8, createdAt: now, updatedAt: now },
  { id: "sub-pharmaceutics-1", courseId: "bpharm", semesterNumber: 1, name: "Pharmaceutics I", description: "Introduction to dosage forms, formulation principles, and drug delivery.", resourceCount: 15, createdAt: now, updatedAt: now },
  { id: "sub-anatomy", courseId: "bpharm", semesterNumber: 1, name: "Human Anatomy & Physiology I", description: "Structure and function of the human body systems.", resourceCount: 10, createdAt: now, updatedAt: now },
  { id: "sub-pharma-chem-2", courseId: "bpharm", semesterNumber: 2, name: "Pharmaceutical Chemistry II", description: "Organic chemistry fundamentals for pharmaceutical applications.", resourceCount: 11, createdAt: now, updatedAt: now },
  { id: "sub-biochemistry", courseId: "bpharm", semesterNumber: 2, name: "Biochemistry", description: "Enzymes, metabolism, and molecular biology of pharmaceutical relevance.", resourceCount: 9, createdAt: now, updatedAt: now },
  { id: "sub-pharmacology-1", courseId: "bpharm", semesterNumber: 3, name: "Pharmacology I", description: "General pharmacology, drug receptors, and pharmacokinetics.", resourceCount: 18, createdAt: now, updatedAt: now },
];
...
export const MOCK_ADMIN_METRICS = {
  totalUsers: 4823,
  totalMarketplaceSales: 156,
  totalUrgentTickets: 42,
  pendingUrgentTickets: 8,
  totalResources: 348,
  totalSubjects: 52,
  activeToday: 287,
  mauThisMonth: 1956,
