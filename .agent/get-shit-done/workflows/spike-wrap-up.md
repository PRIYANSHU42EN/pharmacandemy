...
build conversations. Reads from `.planning/spikes/`, writes skill to `./.agent/skills/spike-findings-[project]/`
...
- [ ] Spike-findings skill exists at `./.agent/skills/` with SKILL.md, references/, sources/
