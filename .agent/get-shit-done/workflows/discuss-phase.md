...
- Read and execute @.agent/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
**Full step-by-step instructions:** @.agent/get-shit-done/workflows/discuss-phase-power.md
